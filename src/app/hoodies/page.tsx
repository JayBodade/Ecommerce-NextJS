        ...
        <div className="container px-5 py-24  md:w-11/12 md:mx-auto ">
          <div className="flex flex-wrap -m-2 ">
            {products && products.map((product: Products, index: number) => {
              ...
              return <Link href={`http://localhost:3000/product/${product.slug}`} key={index} className='lg:w-1/4  hover:scale-105 transition-all duration-300 ease-in-out  lg:mb-4 xl:w-1/5  lg:mx-8 border border-gray-100 lg:m-auto m-auto bg-gray-100   md:w-1/2 p-4 w-full lg:mr-4 '><div className="">
