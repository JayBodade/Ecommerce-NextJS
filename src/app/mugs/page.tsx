  ...
  return (
    <div>
      <div>
          ...
          <div className="container px-5 py-24  md:w-11/12 md:mx-auto ">
            <div className="flex flex-wrap -m-4">
              {products && products.map((product: Products, index: number) => {
                ...
                return <Link href={`/product/${product.slug}`}  key={index} className='lg:w-1/5 lg:mb-4 lg:mx-8 lg:m-auto m-auto border  hover:scale-105 transition-all duration-300 ease-in-out border-gray-300  bg-gray-200  md:w-1/2 p-4 w-full '><div className="">
                ...
                <Image alt={product.title} className="object-cover object-center w-full h-68 block bg-blend-normal"  width={200}
                  height={200} src={product.img}/>                </div>
                <div className="mt-4">
        ...
        return(<div><section className="text-gray-600 body-font min-h-screen ">
